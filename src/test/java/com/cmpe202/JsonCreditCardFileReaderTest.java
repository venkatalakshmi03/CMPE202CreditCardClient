...
class JsonCreditCardFileReaderTest {
    ...
    void emptyFileNameRead() {
        JsonCreditCardFileReader r = new JsonCreditCardFileReader("");
    ...
    void validFileNameRead() {
        Path file = this.workingDir.resolve("sample.json");
        JsonCreditCardFileReader r = new JsonCreditCardFileReader(file.toString());
        List<Record> records = readRecords(r);
    ...
    private static List<Record> readRecords(JsonCreditCardFileReader r) {
